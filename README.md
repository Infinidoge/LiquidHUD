# LiquidHUD
![Gradle Build](https://github.com/Infinidoge/LiquidHUD/workflows/Java%20CI%20with%20Gradle/badge.svg)  
...
* Removes all hacks, keeping only the Custom HUD
* Removes Vanilla version entirely
